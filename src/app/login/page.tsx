...
function LoginForm() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#fafafa] px-6 relative overflow-hidden">
      ...
      {/* subtle brand motif — same map-pin language as the launch poster,
          kept very low-opacity so it reads as texture, not decoration */}
      <svg
        viewBox="0 0 300 300"
        className="absolute -top-10 -left-16 w-72 h-72 opacity-[0.04] pointer-events-none select-none"
      >
